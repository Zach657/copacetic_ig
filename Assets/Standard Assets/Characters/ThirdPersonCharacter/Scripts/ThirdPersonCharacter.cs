...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        [SerializeField]
        float m_BackwardsMoveSpeedMultiplier = 1f;
        [SerializeField]
        ...
        public void Move(Vector3 move, bool crouch, bool jump)
        {
            ...
            // Added coded from https://www.youtube.com/watch?v=_gz3T5rcVbg
            // Allows for proper character walking backwards in first-person (original code was third-person only) I added the AI player stuff and speed multiplier
            if (m_ForwardAmount < 0.0 && !AIPlayer)
            {
                float turnSpeed;
                speedMultiplier = m_BackwardsMoveSpeedMultiplier;
        ...
        void ScaleCapsuleForCrouching(bool crouch)
        {
            if (m_IsGrounded && crouch)
            {
				...
				mainCamTransform.localPosition = new Vector3 (mainCamTransform.localPosition.x, crouchHeight, mainCamTransform.localPosition.z);
            }
            else
            {
				...
				mainCamTransform.localPosition = new Vector3 (mainCamTransform.localPosition.x, standHeight, mainCamTransform.localPosition.z);
            }
        }
