...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        // Peter Wages
        bool m_PlayJumpSound = false;
        bool m_PlayLandingSound = false;
        bool StepsPlaying = false;
        ...
        {
            RotateView();
            if (!m_IsGrounded && m_PlayJumpSound)
            {
                PlayJumpSound();
        ...
        {
            if (Input.GetKey(KeyCode.W) && !StepsPlaying)
            {
                InvokeRepeating("PlayFootStepAudio", 0f, m_StepInterval);
                StepsPlaying = true;
            }
            else if (!Input.GetKey(KeyCode.W) && StepsPlaying)
            {
